  ...
  <body>
    <div class="inv-envelope">
      <div class="inv-envelope-content-wrapper">
        ...
        <div class="inv-envelope-attende-wrapper">
          ...
          <div class="inv-envelope-attende-purpose">
            Tanpa Mengurangi Rasa Hormat Kami Mengundang Anda <br />
    ...
    <div class="thank-wrapper">
      <div class="inv-row">
        <div class="inv-column-6">
          <div class="inv-reveal">
            Merupakan Kebahagiaan Bagi Kami Apabila Anda Berkenan Hadir Pada Acara
            Pernikahan Kami.
          </div>
      ...
      <div class="inv-grid grid-parent">
        <div class="inv-grid grid-parent">
          <div class="inv-grid grid-node footer-data">
            ...
            <span>
              <a
                class="elementor-icon footer-anchor"
                href="https://api.whatsapp.com/send/?phone=6287708250582&text=Saya+tertarik+dengan+produk%20website%20undangan+yang+Anda+kembangkan&type=phone_number&app_absent=0"
                target="_blank"
              >
        ...
        <div class="inv-grid grid-parent">
          <div class="inv-grid grid-node footer-data">
            Email
            <span> support@resepsi-digital.my.id </span>
          </div>
        </div>
      </div>
    </div>
